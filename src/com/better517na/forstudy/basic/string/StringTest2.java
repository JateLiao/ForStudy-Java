...
public class StringTest2 {
    ...
    private Pattern p1 = Pattern.compile("[\\d\\.]{1,4}[M|m|米]{0,1}[\\*Xx,]{1}[\\d\\.]{1,4}[M|m|米]{0,1}");
    ...
    private Pattern p2 = Pattern.compile("[\\d\\.]{1,4}[m|M|米]");
    private Pattern p3 = Pattern.compile("张[\\d\\.]{1,4}");
    private Pattern p4 = Pattern.compile("[\\d\\.]{1,4}");
